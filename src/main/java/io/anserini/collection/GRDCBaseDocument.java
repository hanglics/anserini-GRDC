...
public abstract class GRDCBaseDocument implements SourceDocument {
    private static final Logger LOG = LogManager.getLogger(GRDCBaseDocument.class);
    protected String id;
    ...
    protected final String getFullTextJson(String basePath) {
        ...
        try {
            fullTextJson = new String(Files.readAllBytes(Paths.get(basePath + fullTextPath)));
        } catch (IOException e) {
