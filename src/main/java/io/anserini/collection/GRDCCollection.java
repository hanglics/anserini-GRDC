...
public class GRDCCollection extends DocumentCollection<GRDCCollection.Document> {
    ...
    public static class Document implements SourceDocument {
        ...
        public Document(JsonNode json) {
            ...
            String identifier = json.get("gmd:MD_Metadata").get("gmd:fileIdentifier").get("gco:CharacterString")
                    .asText();
            ...
            this.abstractContent = json.get("gmd:MD_Metadata").get("gmd:identificationInfo")
                    .get("gmd:MD_DataIdentification").get("gmd:abstract").get("gco:CharacterString").asText();
            ...
            JsonNode parties_node = json.get("gmd:MD_Metadata").get("gmd:identificationInfo")
                    .get("gmd:MD_DataIdentification").get("gmd:citation").get("gmd:CI_Citation")
                    .get("gmd:citedResponsibleParty");
            ...
            latitude[0] = json.get("gmd:MD_Metadata").get("gmd:identificationInfo").get("gmd:MD_DataIdentification")
                    .get("gmd:extent").get("gmd:EX_Extent").get("gmd:geographicElement")
                    .get("gmd:EX_GeographicBoundingBox").get("gmd:northBoundLatitude").get("gco:Decimal").asDouble();
            latitude[2] = json.get("gmd:MD_Metadata").get("gmd:identificationInfo").get("gmd:MD_DataIdentification")
                    .get("gmd:extent").get("gmd:EX_Extent").get("gmd:geographicElement")
                    .get("gmd:EX_GeographicBoundingBox").get("gmd:southBoundLatitude").get("gco:Decimal").asDouble();
            ...
            longitude[0] = json.get("gmd:MD_Metadata").get("gmd:identificationInfo").get("gmd:MD_DataIdentification")
                    .get("gmd:extent").get("gmd:EX_Extent").get("gmd:geographicElement")
                    .get("gmd:EX_GeographicBoundingBox").get("gmd:westBoundLongitude").get("gco:Decimal").asDouble();
            longitude[1] = json.get("gmd:MD_Metadata").get("gmd:identificationInfo").get("gmd:MD_DataIdentification")
                    .get("gmd:extent").get("gmd:EX_Extent").get("gmd:geographicElement")
                    .get("gmd:EX_GeographicBoundingBox").get("gmd:eastBoundLongitude").get("gco:Decimal").asDouble();
            // ensuring that a single coordinate location will be drawn as a small rectangle
