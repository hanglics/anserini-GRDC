...
public class Iso19115Collection extends DocumentCollection<Iso19115Collection.Document> {
  ...
  public static class Document implements SourceDocument {
    ...
    static final String[] titlePath = { "gmd:MD_Metadata", "gmd:identificationInfo", "gmd:MD_DataIdentification",
        "gmd:citation", "gmd:CI_Citation", "gmd:title", "gco:CharacterString" };
    protected String abstractContent;
    static final String[] abstractContentPath = { "gmd:MD_Metadata", "gmd:identificationInfo",
        "gmd:MD_DataIdentification", "gmd:abstract", "gco:CharacterString" };
    protected String raw;
    protected String organisation;
    static final String[] organisationPath = { "gmd:MD_Metadata", "gmd:identificationInfo", "gmd:MD_DataIdentification",
        "gmd:abstract", "gco:CharacterString" };
    protected String[] responsibleParty;
    static final String[] responsiblePartyPath = { "gmd:MD_Metadata", "gmd:identificationInfo",
        "gmd:MD_DataIdentification", "gmd:citation", "gmd:CI_Citation", "gmd:citedResponsibleParty" };
    protected String catalogue;
    static final String[] cataloguePath = { "gmd:MD_Metadata", "gmd:contact", "gmd:CI_ResponsibleParty",
    ...
    static final String[] coordinatePath = { "gmd:MD_Metadata", "gmd:identificationInfo", "gmd:MD_DataIdentification",
        "gmd:extent", "gmd:EX_Extent", "gmd:geographicElement", "gmd:EX_GeographicBoundingBox" };
    protected String purpose;
    static final String[] purposePath = { "gmd:MD_Metadata", "gmd:identificationInfo", "gmd:MD_DataIdentification",
        "gmd:purpose", "gco:CharacterString" };
    protected String supplInfo;
    static final String[] supplInfoPath = { "gmd:MD_Metadata", "gmd:identificationInfo", "gmd:MD_DataIdentification",
        "gmd:supplementalInformation", "gco:CharacterString" };
    protected String topicCategory;
    static final String[] topicCategoryPath = { "gmd:MD_Metadata", "gmd:identificationInfo",
        "gmd:MD_DataIdentification", "gmd:topicCategory", "gmd:MD_TopicCategoryCode" };
    protected String[] keywords;
    static final String[] keywordPath = { "gmd:MD_Metadata", "gmd:identificationInfo", "gmd:MD_DataIdentification",
        "gmd:descriptiveKeywords" };
    protected String recommendedCitation;
    static final String[] recommendedCitationPath = { "gmd:MD_Metadata", "gmd:identificationInfo",
        "gmd:MD_DataIdentification", "gmd:citation", "gmd:CI_Citation", "gmd:otherCitationDetails",
        "gco:CharacterString" };
    protected String thesaurusName;
    static final String[] theasurusNameMainPath = { "gmd:MD_Metadata", "gmd:identificationInfo",
    ...
    public Document(JsonNode json) {
      ...
      this.thesaurusName = extractNode(theasurusNameSubPath, mainThesaurusNode).get("gmd:title")
          .get("gco:CharacterString").asText() + " : "
          + extractNode(theasurusNameSubPath, mainThesaurusNode).get("gmd:otherCitationDetails")
              .get("gco:CharacterString").asText();
