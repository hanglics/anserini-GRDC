...
import io.anserini.util.KeyValuePair;
import io.anserini.util.ScorableComparator;
import io.anserini.util.Stopper;

public class RocchioFeatureVector  {
    ...
    // CONSTRUCTORS
    public RocchioFeatureVector(String text, Stopper stopper) {
    ...
    public RocchioFeatureVector(Stopper stopper) {
        this.stopper = stopper;
        if(stopper==null || stopper.asSet().size()==0) {
            analyzer = new StandardAnalyzer();
        } else {
    ...
    public static RocchioFeatureVector interpolate(RocchioFeatureVector x, RocchioFeatureVector y, double xWeight) {
        RocchioFeatureVector z = new RocchioFeatureVector(null);
    ...
    public RocchioFeatureVector deepCopy() {
        RocchioFeatureVector copy = new RocchioFeatureVector(null);
    ...
    public static void main(String[] args) {
        ...
        RocchioFeatureVector RocchioFeatureVector = new RocchioFeatureVector(text, stopper);
        System.out.println(RocchioFeatureVector.getFeatureCount());
        RocchioFeatureVector.clip(5);
        System.out.println(RocchioFeatureVector.getFeatureCount());
    }
