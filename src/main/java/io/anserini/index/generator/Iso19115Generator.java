...
public class Iso19115Generator extends DefaultLuceneDocumentGenerator<Iso19115Collection.Document> {
  ...
  public enum Iso19115Field {
    ...
    COORDINATES("coordinates"), PURPOSE("purpose"), SUPPLINFO("supplinfo"), TOPIC_CATEGORY("topic_category"),
    KEYWORDS("keywords"), RECOMMENDED_CITATION("recommended_citation"), THEASURUS_NAME("theasurus_name");
  ...
  public Document createDocument(Iso19115Collection.Document doc) throws GeneratorException {
    ...
    document
        .add(new StringField(Iso19115Field.RECOMMENDED_CITATION.name, doc.getRecommendedCitation(), Field.Store.YES));
